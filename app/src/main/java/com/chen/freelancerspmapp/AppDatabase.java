...
import com.chen.freelancerspmapp.Dao.BusyTimeDao;
...
@Database(entities = {Project.class, Task.class, BusyTime.class}, version = 1, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    public abstract ProjectDao projectDao();
    public abstract TaskDao taskDao();
    public abstract BusyTimeDao busyTimeDao();
